                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                    {recommendedProducts.map((prod) => (
                      ...
                      >
                        ...
                        <div className="space-y-1.5 mt-3 pt-2.5 border-t border-stone-100">
                          <button
                            onClick={() => {
                              addToCart(prod, prod.colors[0]);
                            }}
                            className="w-full py-2 bg-stone-950 text-white font-bold text-[10px] uppercase tracking-widest hover:bg-stone-800 transition-colors flex items-center justify-center gap-1.5 cursor-pointer shadow-xs"
                          >
                          ...
                          <div className="flex items-center gap-1.5">
                            <button
                              ...
                              className="flex-1 py-1.5 bg-[#FAF8F5] text-stone-900 border border-stone-200 font-bold text-[10px] uppercase tracking-wider hover:bg-stone-100 transition-colors text-center cursor-pointer flex items-center justify-center gap-1"
                            >
                            ...
                            <button
                              ...
                              className="px-2 py-1.5 bg-[#FAF8F5] hover:bg-stone-200 text-stone-800 text-[11px] border border-stone-300 cursor-pointer"
