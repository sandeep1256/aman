        ...
        <div className="flex items-center gap-2 sm:gap-2.5">
          ...
          {user ? (
            ...
            <button
              ...
              className="px-3 py-2 bg-[#FAF8F5] hover:bg-stone-100 text-stone-900 border border-stone-300 font-mono text-[10px] uppercase font-bold tracking-wider flex items-center gap-1.5 cursor-pointer"
            >
